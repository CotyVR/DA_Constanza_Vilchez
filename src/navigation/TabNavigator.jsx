        ...
        <NavigationContainer>
            ...
            >
                <Tab.Screen 
                    ...
                    options={{
                        tabBarIcon: ({focused}) => (<Icon name="store" size={32} color={focused?colors.azulCobalto:colors.cafeClaro} />)
                    }}
                />
                <Tab.Screen 
                    name="Cart" 
                    ...
                    options={{
                        tabBarIcon: ({focused}) => (<Icon name="shopping-cart" size={32} color={focused?colors.azulCobalto:colors.cafeClaro} />)
                    }}
                />
                <Tab.Screen 
                    name="Receipts" 
